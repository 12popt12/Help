...
const TypingIndicator: React.FC = () => (
    <div className="flex items-start gap-3 my-4">
        ...
        <div className="max-w-xl p-4 rounded-xl shadow bg-gray-700/80 rounded-bl-none flex items-center space-x-2 space-x-reverse">
...
const WelcomeMessage: React.FC<{activeModel: ModelType}> = ({ activeModel }) => {
    ...
    return (
        <div className="text-center p-8 flex flex-col items-center">
            ...
            <h2 className="text-2xl font-bold text-gray-200">نموذج {modelInfo?.name}</h2>
            <p className="text-gray-400 mt-2">{modelInfo?.description}</p>
        </div>
    );
}
