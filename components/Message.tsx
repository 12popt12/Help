  ...
  if (isError) {
    return (
      <div className="flex justify-center">
        <div className="bg-red-100 dark:bg-red-900/50 text-red-700 dark:text-red-300 border border-red-300 dark:border-red-700 px-4 py-2 rounded-lg text-sm">
          {message.content}
        </div>
      </div>
    );
    ...
    <div className={containerClasses}>
      ...
      <div
        className={`${bubbleClasses} ${
          isUser ? 'bg-cyan-600/90 text-white rounded-br-none' : 'bg-white dark:bg-gray-700/80 rounded-bl-none'
        }`}
      >
        <div
            className="prose prose-sm prose-slate dark:prose-invert max-w-none prose-p:my-2 prose-headings:my-3"
